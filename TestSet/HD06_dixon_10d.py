...
Source:
http://www.apmath.spbu.ru/cnsa/pdf/obzor/An%20Unconstrained%20Optimization%20Test%20Functions%20Collection.pdf
...
def objfun_derivs(x,component = 0):
    ...
    if component == 0:
        ...
        term1 = 0.
        term2 = -2 + 2*x[dim-1]
        term3 = -2*x[dim-2] + 2*x[dim-1]
        deriv = term1 + term2 + term3
    else:
        term1 = 0.
        term2 = 0.
        term3 = 4*x[i] - 2*x[i+1] -2*x[i-1]
        deriv = term1 + term2 + term3
    return deriv
