...
def objfunc(x):
    f = 100.0 * (x[1] - x[0] ** 2) ** 2 + (1.0 - x[0]) ** 2 + 100.0 * (x[2] - x[1] ** 2) ** 2 + (1.0 - x[1]) ** 2 + 100.0 * (x[3] - x[2] ** 2) ** 2 + (1.0 - x[2]) ** 2
    return f
...
def objfun_derivs(x,component = 0):
    if component == 0:
        ...
        deriv = 400*x[1]**3 + 2*x[1] - 400*x[1]*x[2] -2 + 200*x[1] - 200*x[0]**2 
    elif component == 2:
        deriv = 400*x[2]**3 + 2*x[2] - 400*x[2]*x[3] -2 + 200*x[2] - 200*x[1]**2
    elif component == 3:
        deriv = 200*x[3] - 200*x[2]**2
    return deriv
...
x_lb = np.array([-10.0, -10.0, -10., -10])
x_ub = np.array([10., 10., 10., 10])
